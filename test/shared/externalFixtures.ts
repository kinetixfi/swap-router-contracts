...
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@kinetix/v2-core/build/KinetixV2Factory.json'
...
export const v3RouterFixture: Fixture<{
  ...
  ).deploy(factoryV2.address, factory.address, nft.address, weth9.address)) as unknown as MockTimeSwapRouter02
